...
public class InventoryTest extends BaseTest {
	...
	public void addFirstProductToCartFromInventoryPage() {
		...
		try {
			Assert.assertEquals(cartBadgeCount, 1, "Cart badge should show item 1");
			test.pass("Cart badge updated to 1");
		} catch (AssertionError e) {
			ScreenshotUtil.captureScreenShots(getDriver(), "AddToCartFailed");
			throw e;
		}
	}
